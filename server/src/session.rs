...
impl Session {
    pub fn new(client: tower_lsp::Client) -> Self {
        Self {
            ...
            built_in_slice_path: Mutex::new(String::new()),
        }
    }
    ...
    pub async fn fetch_configurations(&self) {
        ...
        let root_uri_guard = self.root_uri.lock().await;
        let root_uri = match *root_uri_guard {
            Some(ref uri) => uri,
            None => return,
        };
